            ...
            <div className="sticky top-0 bg-white z-10 border-b border-gray-100 lg:border-none p-4 lg:p-6 lg:bg-transparent">
                <div className="flex items-center justify-between max-w-5xl mx-auto w-full">
                    <div className="flex items-center gap-3">
                        ...
                        <h1 className="text-xl font-bold text-[#1a237e] lg:text-3xl">Amenities</h1>
                    </div>
                    <Link href="/amenities/my-bookings" className="flex items-center gap-2 text-sm font-semibold text-[#1a237e] bg-blue-50 px-3 py-1.5 rounded-lg hover:bg-blue-100 transition-colors">
            ...
            <div className="p-4 lg:p-6 max-w-5xl mx-auto w-full space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 lg:gap-6">
                    {amenities.map((amenity) => {
                        ...
                        return (
                            <Link href={`/amenities/${amenity.id}`} key={amenity.id} className="group block relative overflow-hidden rounded-3xl cursor-pointer shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 bg-white">
                                ...
                                <div className="p-5">
                                    <div className="flex justify-between items-start mb-2">
                                        <h3 className="text-lg font-bold text-gray-900 group-hover:text-[#1a237e] transition-colors">{amenity.name}</h3>
                                        <div className={cn("h-10 w-10 rounded-full flex items-center justify-center -mt-10 border-4 border-white", iconBg)}>
                                            <Icon size={18} className={iconColor} />
                                        </div>
                                    </div>
                                    <p className="text-sm text-gray-500 line-clamp-2 mb-4">{amenity.description}</p>
