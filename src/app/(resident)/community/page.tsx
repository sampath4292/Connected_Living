...
export default function CommunityPage() {
    ...
    return (
        <div className="flex flex-col h-screen bg-[#f8f9fa] pb-24 lg:pb-0">
            {/* Header */}
            <div className="bg-white px-6 py-6 rounded-b-[2rem] border-b border-gray-100 flex items-center justify-between shadow-sm z-20">
                <div className="flex items-center gap-1">
                    <div>
                        <h1 className="text-2xl font-extrabold text-[#1a237e] tracking-tight">Community Hub</h1>
