                ...
                <div className="flex items-center justify-between max-w-4xl mx-auto w-full">
                    ...
                    <div className="hidden lg:flex items-center gap-3">
                        <button
                            ...
                            className="bg-muted text-foreground px-4 py-2 rounded-xl text-sm font-bold flex items-center gap-2 hover:bg-accent transition-all active:scale-95 border border-border"
                        >
                            <User size={18} />
                            Saved Visitors
                        </button>
                        <Link
                            ...
                            className="bg-primary text-white px-5 py-2 rounded-xl text-sm font-bold flex items-center gap-2 shadow-lg shadow-primary/20 hover:opacity-90 transition-all active:scale-95"
                        >
                            <Plus size={18} />
                            Invite Visitor
                        </Link>
