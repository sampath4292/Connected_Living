...
export default function LoginPage() {
    ...
    if (showSplash) {
        return (
            <div className="fixed inset-0 bg-primary flex flex-col items-center justify-center z-50 animate-out fade-out duration-700 delay-[1800ms] fill-mode-forwards">
                <div className="flex flex-col items-center animate-in zoom-in-50 duration-700 ease-out">
                    ...
                    <p className="text-primary-foreground/70 text-sm font-medium mt-2 tracking-widest uppercase">Community App</p>
                </div>
    ...
    return (
        <div className="min-h-screen bg-background flex items-start justify-center relative overflow-hidden animate-in fade-in duration-1000">

            {/* 1. Curved Blue Header Background */}
            <div className="absolute top-0 inset-x-0 h-[45vh] bg-primary rounded-b-[3rem] lg:rounded-b-[50%] lg:scale-x-110 flex items-start justify-center pt-16 z-0 shadow-2xl">
                {/* Background Pattern */}
                ...
                <div className="text-center text-white relative z-10 animate-in slide-in-from-top-10 duration-700">
                    ...
                    <p className="text-primary-foreground/70 text-sm font-medium mt-1 tracking-wide uppercase">Community Super App</p>
                </div>
            </div>

            {/* 2. Floating Login Card */}
            <div className="w-full max-w-md bg-card/95 backdrop-blur-xl rounded-[2.5rem] shadow-[0_30px_70px_-20px_rgba(0,0,0,0.15)] p-8 relative z-10 mt-[30vh] mx-4 animate-in slide-in-from-bottom-20 duration-700 border border-border ring-1 ring-border/50">
                <div className="mb-10 text-center">
                    <h2 className="text-3xl font-bold text-foreground tracking-tight">Welcome Back!</h2>
                    <p className="text-muted-foreground font-medium text-sm mt-3 px-4 leading-relaxed">
                        Sign in to manage your <span className="text-primary font-bold">Connected Living</span> experience.
                    </p>
                </div>
                ...
                <form className="space-y-6" onSubmit={handleLogin}>
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="relative group transition-all focus-within:scale-[1.01]">
                                ...
                                <Input
                                    ...
                                    className="pl-11 pr-11 h-14 bg-muted border-border focus:bg-card focus:border-primary/20 focus:ring-4 focus:ring-primary/10 rounded-2xl text-base transition-all font-medium text-foreground placeholder:text-muted-foreground placeholder:font-normal"
                                    placeholder="••••••••"
                                    value={password}
                    ...
                    <Button
                        className="w-full h-14 rounded-2xl text-[15px] font-bold tracking-wide bg-primary hover:bg-primary/90 shadow-lg shadow-primary/20 hover:shadow-primary/40 transition-all hover:-translate-y-0.5 mt-2"
                        type="submit"
                        disabled={isLoading}
                    >
                        {isLoading ? (
            ...
            {/* Bottom Credits */}
            <div className="absolute bottom-6 flex gap-4 text-muted-foreground text-[10px] font-bold uppercase tracking-widest opacity-50">
                <span>Terms</span>
                <span>•</span>
                <span>Privacy</span>
                <span>•</span>
